  ...
  return (
    <>
      <div className={`min-h-screen w-full transition-colors duration-300`}>
        ...
        <div className="dark:tobg-gradient-to-track relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 dark:from-indigo-950 dark:to-black">
          ...
          <div className="absolute inset-0">
            <div
              className="animate-pulse-slow absolute inset-0 bg-gradient-to-bl from-blue-400/20 via-blue-400/10 to-transparent dark:from-blue-800/40 dark:via-blue-950/50"
              style={{ backgroundPosition: '50% 20%' }}
            ></div>
            <div
              className="animate-pulse-slow absolute inset-0 bg-gradient-to-bl from-purple-400/20 via-purple-400/10 to-transparent dark:from-purple-800/40 dark:via-purple-950/50"
              style={{ backgroundPosition: '20% 10%', animationDelay: '-2s' }}
            ></div>
            <div
              className="animate-pulse-slow absolute inset-0 bg-gradient-to-bl from-pink-400/20 via-pink-400/10 to-transparent dark:from-pink-800/40 dark:via-pink-950/50"

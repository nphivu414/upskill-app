...
// TODO:
// Try to list all the files needed to create the FeaturePhotos component then we can break down each file step by step.
// Explain more about the cn util class from NextUI
